	...
	return (
		<AppLayout>
			<section className='w-full h-full flex flex-col py-4'>
				<MenuClient />
				<section className='w-[90%] grid grid-cols-6 gap-8 items-center justify-center'>
					...
					<div className='relative flex flex-col col-span-4 gap-6 bg-gray-200 p-3 rounded-2xl hover:shadow-lg hover:shadow-gray-200 hover:scale-105 transition duration-500 ease-linear'>
